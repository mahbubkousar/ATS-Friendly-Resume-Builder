...
CREATE TABLE `users` (
  ...
  `ai_processing_consent_at` timestamp NULL DEFAULT NULL,
  `ai_consent_version` varchar(20) DEFAULT NULL,
...
--
-- Security counter tables introduced by migrations 001 and 002
--
